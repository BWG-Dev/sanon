...
class SanonMeetingAreas
{
	...
	{
		wp_register_style( 'meeting-areas', get_stylesheet_directory_uri() . '/inc/meeting-areas/meeting-areas.css', [], '1.0.1', 'all' );
		wp_register_script( 'meeting-areas', get_stylesheet_directory_uri() . '/inc/meeting-areas/meeting-areas.js', ['jquery'], '1.0.1', 'all' );
						...
						if($country->children): ?>
							...
							<div class="state-list">
								<?php foreach($country->children as $state): ?>
									<span class="state" data-load-meetings-by-area="<?php echo $state->term_id; ?>"><?php echo $state->name; ?></span><br>
								<?php endforeach; ?>
							</div>
						<?php endif; ?>
					</div>
