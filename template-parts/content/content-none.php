...
<section class="no-results not-found">
	...
	<div class="page-content">
		...
		elseif ( is_search() ) :
			...
			<p><?php _e( 'We are sorry, but nothing matched the search term you entered. Please try again with a new search term, or visit our <a href="https://sanon.org/newcomers/faq/">FAQ page</a>.', 'twentynineteen' ); ?></p>
			<?php
			get_search_form();
