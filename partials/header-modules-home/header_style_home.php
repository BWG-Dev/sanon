<header id="masthead" class="home" style="background-image: url(<?php the_sub_field('background_image'); ?>);
	<?php include __DIR__.'/../header-modules/top-header.php'; ?>
	<?php the_sub_field('background_style'); ?>">

    <div class="mobile-menu-holder">
        <p>
            <a class="mobile-burger" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false"
                aria-controls="collapseExample">
                <img src="<?php the_sub_field('mobile_burger'); ?>">
            </a>
        </p>
    ...
    <div class="site-branding-container">
		<div class="topbar main-topbar">
			<div class="container">
                <div class="row">
                    <div class="col-xl-12 text-center">
                        <?php dynamic_sidebar('home-topbar'); ?>
                    </div>
